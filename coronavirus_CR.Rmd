...
d.con$Province.State<-as.factor(d.con$Province.State)
d.con$Country.Region<-as.factor(d.con$Country.Region)

d.rec$Province.State<-as.factor(d.rec$Province.State)
d.rec$Country.Region<-as.factor(d.rec$Country.Region)

d.dea$Province.State<-as.factor(d.dea$Province.State)
d.dea$Country.Region<-as.factor(d.dea$Country.Region)
...
##
d.pop$Country.Name<-as.factor(d.pop$Country.Name)
